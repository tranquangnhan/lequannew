...
CKEDITOR.editorConfig = function(config) {
    ...
    config.filebrowserBrowseUrl = 'https://lequansneaker.com/lib/ckfinder/ckfinder.html';
    config.filebrowserUploadUrl = 'https://lequansneaker.com/lib/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files';
