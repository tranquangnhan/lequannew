...
//    require_once "../languages/".$_SESSION['lang'].".php";	
   ...
   class Home{
       function __construct()   {
        ...
        {
			$getMenuParent = $this->model->getMenuParent();
			$page_title ="Giới Thiệu - Lê Quân Sneaker";
        ...
        function cat(){
			...
			$page_title ="Danh Mục Sản Phẩm - Lê Quân Sneaker";
        ...
        function cartView(){
   			$getMenuParent = $this->model->getMenuParent();
			$page_title ="Giỏ Hàng - Lê Quân Sneaker";
...
/*
	...
	function createklarnaqr()
	{
	 ...
	 function checkout()
	 {
		$getMenuParent = $this->model->getMenuParent();
		$this->saveBill();
		$page_title ="Thanh Toán - Lê Quân Sneaker";
	 ...
	 function ttthanhcong()
	 {
		...
		$page_title ="Thanh Toán Thành Công - Lê Quân Sneaker";
	 ...
	 function thankYou()
	 {
		...
		$getMenuParent = $this->model->getMenuParent();
		$page_title ="Cảm Ơn - Lê Quân Sneaker";
	 ...
	 {  
		...
		$page_title ="Đăng Nhập - Lê Quân Sneaker";
	 ...
	 function register()
	 {
		...
		$page_title ="Đăng Ký - Lê Quân Sneaker";
	 ...
	 function forgotPass(){
		$page_title ="Quên Mật Khẩu - Lê Quân Sneaker";
		$viewFile ="views/forgotpass.php";
		require_once "views/layout.php";
	 }
	 function changePass()
	 {
		$page_title ="Đổi Mật Khẩu - Lê Quân Sneaker";
	 ...
	 function contact(){
		...
		$page_title ="Liên Hệ - Lê Quân Sneaker";
		$viewFile ="views/contact.php";
		require_once "views/layout.php";
	 }
	 function baohanh(){
		$getMenuParent = $this->model->getMenuParent();
		$page_title ="Bảo Hành - Lê Quân Sneaker";
	 ...
	 function termofservice(){
		$getMenuParent = $this->model->getMenuParent();
		$page_title ="Chính Sách Vận Chuyển - Lê Quân Sneaker";
	 ...
	 function notification(){
		...
		$page_title ="Thông Báo - Lê Quân Sneaker";
		require_once "views/thankyou.php";
	 }
	 function donecheckout(){
		$page_title ="Hoàn Tất Thanh Toán - Lê Quân Sneaker";
