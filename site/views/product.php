        ...
        <div class="row" style="margin-left: 0px">
            ...
            <div id="_desktop_left_column" class=" col-xs-12 col-sm-12 col-md-12 col-lg-3">
                <div id="left-column" class="">                    
                 <div class="d-none featured-products clearfix mt-3 hb-animate-element right-to-left hb-in-viewport ">
              
                <p class="text-uppercase h6 hidden-sm-down">Tìm Kiếm Giá</p>


                <section class="facet clearfix">
                    <p class="h6 facet-title hidden-sm-down"></p>
                    <ul class="collapse gia">
                    ...
                    <div id="search_filters_wrapper" class="hidden-sm-down">
                        ...
                        <?php } else{ ?>
                            ...
                            <p class="text-uppercase h6 hidden-sm-down">Tìm Kiếm</p>
...
<!-- 
                    ...
                    <section class="none-mobile featured-products clearfix mt-3 hb-animate-element right-to-left">
                                                    ...
                                                    <div class="thumbnail-container">
                                                        <div class="thumbnail-inner">
                                                            ...
                                                            <a href="'.$link.'"
                                                                ...
                                                                <img class="second_image img-responsive lazy" width="70" height="90"
                                                                    src="'.$imgCover.'"
                                                                    alt="" title="" />
                                                            </a>
                    ...
                    <section class="none-mobile featured-products clearfix mt-3 hb-animate-element left-to-right">
                        <h3 class="h1 products-section-title left-product-title text-uppercase hidden-md-down ">
                            Bán chạy
                        </h3>
                                                        ...
                                                        <div class="thumbnail-inner">
                                                            ...
                                                            <a href="'.$link.'"
                                                                ...
                                                                <img class="lazy" src="'.$img.'"
                                                                    alt="Neque Porro Suisquam"
                                                                    data-full-size-image-url="'.$img.'" width="70" height="90">
                                                                <img class="second_image img-responsive lazy"
                                                                    src="'.$imgCover.'"
                                                                    alt="" title="" />
                                                            </a>
                            ...
                            <div>
                               ...
                               ?>
                                ...
                                <div id="js-product-list">
                                    ...
                                    <div class="products product-thumbs " id="filter_data">
