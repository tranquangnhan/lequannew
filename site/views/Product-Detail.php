                                ...
                                <div class="images-container">
                                    ...
                                    <div class="product-cover">
                                        ...
                                        <img id="zoom" class="js-qv-product-cover zoomLens imgdetail"
                                            src="<?=$avt?>"
                                            alt="" title="" style="width:100%;object-fit:cover;" itemprop="image">
                                        ...
                                        <li>
                                            <div class="block-reassurance-item">
                                                <!-- <img src="views/assets/img/ic_verified_user_black_36dp_1x.png"
                                                    alt="Security policy (edit with Customer reassurance module)"> <br> -->
                                                <span class="h6">- Sản phẩm các bạn đang nhìn thấy,hàng copy đạt 99%. <br>
- Cam kết hình ảnh và chất lượng như nhau (best quality). <br>
- Chất lượng được chọn lọc những phiên bản cao cấp nhất và nhà máy tốt nhất.</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="block-reassurance-item">
                                                ...
                                                <span class="h6">- Hàng được kiểm tra trước khi thanh toán,freeship nội thành TP.HCM.
</span>
                                            </div>
                                        </li>
                                        <!-- <li>
